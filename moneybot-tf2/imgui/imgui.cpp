...
void ImGui::RenderTextClipped(const ImVec2& pos_min, const ImVec2& pos_max, const char* text, const char* text_end, const ImVec2* text_size_if_known, const ImVec2& align, const ImRect* clip_rect, bool shadow)
{
    // Hide anything after a '##' string
...
void ImGui::RenderFrame(ImVec2 p_min, ImVec2 p_max, ImU32 fill_col, bool border, float rounding)
{
    ...
    if (border && border_size > 0.0f)
    {
        ...
        window->DrawList->AddRect(p_min, p_max + ImVec2(0, 0), GetColorU32(ImGuiCol_Border), rounding, ImDrawCornerFlags_All, border_size);
    }
}
...
ImVec2 ImGui::CalcTextSize(const char* text, const char* text_end, bool hide_text_after_double_hash, float wrap_width, float fontsize)
{
    ImGuiContext& g = *GImGui;
    ...
    ImVec2 text_sizeX =  font->CalcTextSizeA(font_size, FLT_MAX, wrap_width, text, text_display_end, NULL);

    // Round
    text_sizeX.x = IM_FLOOR(text_sizeX.x + 0.95f);
