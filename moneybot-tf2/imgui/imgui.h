...
namespace ImGui
{
	...
	IMGUI_API void			Keybind(const char* name, unsigned int* Key);
    // Widgets: Combo Box
    ...
    // Text Utilities
    IMGUI_API ImVec2        CalcTextSize(const char* text, const char* text_end = NULL, bool hide_text_after_double_hash = false, float wrap_width = -1.0f, float fontsize = 0.0f);
