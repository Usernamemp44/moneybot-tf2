...
void bf_write::WriteBitVec3Coord(const Vector3& fa)
{
...
void bf_write::WriteBitVec3Normal(const Vector3& fa)
{
	int		xflag, yflag;
...
void bf_write::WriteBitAngles(const Vector3& fa)
{
	// FIXME:
	Vector3 tmp(fa.x, fa.y, fa.z);
...
void bf_read::ReadBitVec3Coord(Vector3& fa)
{
	int		xflag, yflag, zflag;
...
void bf_read::ReadBitVec3Normal(Vector3& fa)
{
...
void bf_read::ReadBitAngles(Vector3& fa)
{
	Vector3 tmp;
