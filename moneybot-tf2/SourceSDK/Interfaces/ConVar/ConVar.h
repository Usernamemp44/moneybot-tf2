...
public:
	...
	virtual const ConVar *FindVarConst(const char *var_name) const = 0;
	...
	virtual void ConsoleColorPrintf(const RGBA &clr, const char *pFormat, ...) const = 0;
