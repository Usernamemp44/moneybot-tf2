...
public:
	...
	virtual void				SetLight(int lightNum, int* desc) = 0;
	virtual void				SetAmbientLightCube(Vec34D cube[6]) = 0;
	...
	virtual void				GetMatrix(int matrixMode, VMatrix* matrix) = 0;
	virtual void				GetMatrix(int matrixMode, matrix3x4* matrix) = 0;
	...
	virtual IIndexBuffer* GetDynamicIndexBuffer(int fmt, bool bBuffered = true) = 0;
	...
	virtual void				SetLightingOrigin(/*Vec3 vLightingOrigin*/float x, float y, float z) = 0;																		//158
	...
	virtual void				AccumulateMorph(IMorph* pMorph, int nMorphCount, const int* pWeights) = 0;
	...
	virtual bool				GetMorphAccumulatorTexCoord(void* pTexCoord, IMorph* pMorph, int nVertex) = 0;
	...
	virtual void SetNonInteractiveTempFullscreenBuffer(ITexture* pTexture, int mode) = 0;
